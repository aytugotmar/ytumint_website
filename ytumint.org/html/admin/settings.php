...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $db->query("UPDATE site_settings SET setting_value = ? WHERE setting_key = 'youtube_video_id'", [$youtube_video_id]);
...
<head>
    ...
    <title>Ayarlar - YTU MINT Admin</title>
...
<body>
    <aside class="sidebar">
        ...
        <ul class="sidebar-menu">
            ...
            <li><a href="settings.php" class="active"><i class="fas fa-cog"></i> <span>Ayarlar</span></a></li>
        </ul>
    </aside>
    ...
    <main class="main-content">
        ...
        <div class="content-area">
            ...
            <div class="form-container">
                <h2 style="margin-bottom: 30px;">Admin Giriş Ekranı</h2>
                
                <form method="POST">
                    <div class="form-group">
                        <label for="youtube_video_id">YouTube Video ID</label>
                        <input type="text" id="youtube_video_id" name="youtube_video_id" 
                               value="<?php echo htmlspecialchars($settings['youtube_video_id'] ?? ''); ?>"
                               placeholder="dQw4w9WgXcQ">
                        <small style="color: #666; display: block; margin-top: 5px;">
                            YouTube video URL'sinden sadece video ID'sini girin. Örnek: https://www.youtube.com/watch?v=<strong>dQw4w9WgXcQ</strong>
                        </small>
                    </div>

                    <div class="alert alert-info">
                        <i class="fas fa-info-circle"></i> Bu video admin giriş ekranında arka planda otomatik oynatılacak ve döngüde çalışacaktır.
                    </div>
